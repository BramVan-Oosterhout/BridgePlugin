...
---+ package Foswiki::Plugins::BridgePlugin
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{BridgePlugin}{ExampleSetting} = 1;
    ...
    # LocalSite.cfg.
    # my $setting = $Foswiki::cfg{Plugins}{BridgePlugin}{ExampleSetting} || 0;
...
sub _bridgePlay {
    ...
    return Foswiki::Plugins::BridgePlugin::Board->new( $session, $web, $topic )
      ->bridgePlay( $params, $topicObject );
}
...
sub _bridgeHands {
    ...
    return Foswiki::Plugins::BridgePlugin::Board->new( $session, $web, $topic )
      ->bridgeHands( $params, $topicObject );
...
sub _bridgeAuction {
    ...
    return Foswiki::Plugins::BridgePlugin::Board->new( $session, $web, $topic )
      ->bridgeAuction( $params, $topicObject );
}
